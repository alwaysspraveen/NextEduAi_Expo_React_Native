      ...
      items: [
        {
          ...
          href: "/student_timetable" as const,
        },
        {
          key: "assignments",
          label: "Assignments",
          icon: <BookIcon size={36} />,
          href: "/(student_features)/student_assignments" as const,
        },
        {
          key: "exams",
          label: "Exams",
        ...
        },
        {
          ...
          href: "/(student_features)/content" as const,
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          href: "/(student_features)/student_attendance" as const,
        },
        {
          key: "grades",
      ...
      items: [
        {
          ...
          href: "/(student_features)/student_leave" as const,
        },
        {
          key: "calendar",
          label: "Calendar / Events",
          icon: <CalenderIcon size={36} />,
          href: "/(student_features)/calendar" as const,
        },
      ],
    },
  ];
